...
echo "  Ask each voter at Computer 2, 3, 4 to open their browser"
echo "  and click YES or NO on the voting page."
echo ""
echo "  Talking point: 'When a voter clicks YES, their browser"
echo "  calls the local Node.js server, which calls our C++ binary"
